	...
	<div className="container">
		<div className="row ipad-width2">
			<div className="col-md-8 col-sm-12 col-xs-12">
				...
				<Pelicula titulo="Oblivion (2012)" calificacion="8.1" descripcion="Earth's mightiest heroes must come together and learn to fight as a team if they are to stop the mischievous Loki and his alien army from enslaving humanity..." 
				duracion="Run Time: 2h21’" clasificacion="MMPA: PG-13" lanzamiento="Release: 1 May 2015" director="Joss Whedon" reparto="Robert Downey Jr, Chris Evans, Chris Hemsworth" />
				
				<Pelicula titulo="Testeando (2012)" calificacion="9.1" />

				<Pelicula titulo="Ando (2012)" calificacion="8.9" />
